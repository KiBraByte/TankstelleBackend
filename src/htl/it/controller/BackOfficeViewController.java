...
public class BackOfficeViewController extends Controller{
    public BackOfficeViewController(DBConnection dbConnection) {
        super(dbConnection);
    }
    ...
    public ResponseBuilder controller(HTTPRequest req, ResponseBuilder res, HashMap<String, String> param) {
        ...
        return res.html("backoffice/backoffice.html");
    }

    @Override
    public String getRoute() {
        return "/backoffice/:sessionID";
    }
